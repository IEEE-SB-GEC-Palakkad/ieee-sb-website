        ...
        <div className="event-details hidden sm:flex">
          <div className="event-contents w-2/3">
            ...
            <div className="event-actions"> {isExcelsior && (
               <Link to="src/components/Events/Excelsior2025/excelsior25.html" target="_blank" className="btn my-3 px-4 rounded-full shadow-md hover:text-white bg-[#00567D] inline-block" > 
                Know More
              </Link> 
              )} 
            </div>
