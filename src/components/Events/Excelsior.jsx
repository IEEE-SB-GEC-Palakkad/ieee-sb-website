...
const Excelsior = () => {
  ...
  const handleDownloadPDF = () => {
    try {
      ...
      alert(
        "Sorry, there was an issue downloading the PDF. Please try again later."
      );
    }
  };
  ...
  const handleDownloadZip = () => {
    try {
      window.open(
        "/pdf/IEEE Symposium-2025_Poster Template_LaTeX.zip",
        "_blank"
      );
    } catch (error) {
      console.error("Error downloading ZIP file:", error);
      alert(
        "Sorry, there was an issue downloading the ZIP file. Please try again later."
      );
    }
  };
  ...
  return (
    <div className="symposium-page container mx-auto px-4 py-8">
        ...
        <div className="symposium-details md:w-2/3">
          ...
          <div className="additional-info bg-blue-900 p-4 rounded-md border border-gray-200 mb-6">
            ...
            <ul className="list-disc pl-5 text-gray-200">
              <li>
                <strong>Platform for Innovation:</strong> Present your ideas and
                projects to a panel of experts.
              </li>
              <li>
                <strong>Expert Evaluation:</strong> Receive constructive
              ...
              <li>
                <strong>Technical Sponsorship:</strong> Supported by IEEE
                Malabar Subsection.
              </li>
              <li>
                <strong>Organized by:</strong> Department of Electrical
                Engineering, GEC Palakkad.
              </li>
              <li>
                <strong>Annual Symposium:</strong> A flagship event in
                association with IEEE Student Branch, GEC Palakkad.
              </li>
              <li>
                <strong>Encouraging Creativity:</strong> Explore emerging
                technologies with curiosity and innovation.
              </li>
              <li>
                <strong>Paper Submission:</strong> Submit a one-page summary on
                topics like drives, control, robotics, AI, and computing.
              </li>
              <li>
                <strong>Publication Opportunity:</strong> Selected summaries
                will be published in the Institute Symposium Proceedings.
              </li>
              <li>
                <strong>Fostering Collaboration:</strong> Engage in insightful
                discussions and groundbreaking ideas to drive innovation.
              </li>
            </ul>
          </div>
      ...
      <div className="registration-info mt-10 p-6 bg-blue-900 rounded-lg border border-blue-100">
        <h3 className="text-xl font-bold text-[#eceff1] mb-4">
          Registration Information
        </h3>
        <p className="mb-4 text-gray-200">
          Registration for the IEEE Symposium is now open
          <br />
          Join us for this exciting platform to showcase your innovative ideas
          and projects!
        </p>
        <button
